      ...
      <div className="bg-white p-8 shadow-lg rounded-lg w-96">
        ...
        <form onSubmit={handleRegister}>
          ...
          <div className="mb-4">
            ...
            <input type="password" className="w-full px-4 py-2 border rounded-lg" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} required />
